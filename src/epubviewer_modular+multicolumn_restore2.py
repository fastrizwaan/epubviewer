                ...
                if '|' in val_str:
                    ...
                    if match:
                        ...
                        if left > 0 or top > 0:
                            ...
                            print(f"[SCROLL] 💾 Saved position for chapter {self.current_index}: ({left}, {top})")
                        else:
                            print(f"[SCROLL] ⚠️ Both values are 0, not saving")
                    else:
            ...
            try:
                ...
                if '|' in val_str:
                    ...
                    if match:
                        ...
                        if left > 0 or top > 0:
                            # Save in new dict format for consistency
                            self.saved_scroll_positions[self.current_index] = {
